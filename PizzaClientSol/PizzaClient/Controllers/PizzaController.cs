...
namespace PizzaClient.Controllers
{
    ...
    {  
        ...
        //[HttpGet]
        //public async Task<ActionResult> Alter(int id)
        //{
        ...
        //}
        //[HttpPost]
        //public async Task<ActionResult> Alter(OrderDetails Od)
        //{
        ...
        //    {
        //        StringContent content = new StringContent(JsonConvert.SerializeObject(Od), Encoding.UTF8, "application/json");
        //        using (var response = await client.PutAsync("http://localhost:30297/api/OrderDetails/"+ Od.OrderId, content))
        //        {
        //            string apiResponse = await response.Content.ReadAsStringAsync();
        //            od = JsonConvert.DeserializeObject<OrderDetails>(apiResponse);
        //        }
